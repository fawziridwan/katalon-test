...
WebUI.sendKeys(findTestObject('Object Repository/Product/add/input_pilih_kategori'), Keys.chord(Keys.DOWN, Keys.ENTER))

WebUI.click(findTestObject('Object Repository/Product/add/div_Bahan Kimia'))

not_run: WebUI.click(findTestObject('Object Repository/Product/add/div_Pilih_css-ackcql'))

not_run: WebUI.setText(findTestObject('Object Repository/Product/add/input_Bahan Kimia_react-select-7-input'), 'Asbes')

not_run: WebUI.click(findTestObject('Object Repository/Product/add/div_Asbes'))
