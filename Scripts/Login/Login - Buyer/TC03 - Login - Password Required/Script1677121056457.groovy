...
WebUI.sendKeys(findTestObject('Login/or_login_buyer/input_buyer_password'), Keys.chord(Keys.BACK_SPACE, Keys.BACK_SPACE, 
        Keys.BACK_SPACE, Keys.BACK_SPACE, Keys.BACK_SPACE, Keys.BACK_SPACE, Keys.BACK_SPACE, Keys.BACK_SPACE))

WebUI.getText(findTestObject('Login/or_login_buyer/message_buyer_password_required'))

WebUI.verifyTextPresent('Kata sandi wajib diisi', false)
